...
const nftImagePath = fileURLToPath(new URL('./assets/nft.png', import.meta.url))
...
export const setRewardTypeNftUploadMediaNameContractCap12 = async (
  ...
  await page.locator('input[type="file"]').nth(1).setInputFiles(nftImagePath)
...
export async function setUpPointsReward(page: Page) {
  // console.log('-------- setUp Points Reward --------')

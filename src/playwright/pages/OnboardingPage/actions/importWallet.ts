...
export async function importWallet(
  ...
  await page
    .locator(Selectors.GetStartedPageSelectors.termsOfServiceCheckbox)
    .click()
  ...
  await page
    .locator(Selectors.WalletCreationSuccessPageSelectors.confirmButton)
    .click()

...
const editTokenPermission = async (
  notificationPage: Page,
  customSpendLimit: 'max' | number,
) => {
  if (customSpendLimit === 'max') {
    await notificationPage
      .locator(Selectors.PermissionPage.approve.maxButton)
      .click()
    return
  }
...
const approveTokenPermission = async (
  notificationPage: Page,
  gasSetting: GasSettings,
) => {
  // Click the "Next" button.
  await notificationPage
    .locator(Selectors.ActionFooter.confirmActionButton)
    .click()
